      ...
      <Container>
        <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-4">
          ...
          <div>
            ...
            <p className="text-sm leading-relaxed text-zinc-600 dark:text-zinc-400">
              A modern developer blog featuring articles about web development,
              JavaScript, React, and frontend technologies.
            </p>
          </div>
        ...
        <div className="mt-12 border-t border-zinc-200 pt-8 dark:border-zinc-800">
          <div className="flex flex-col items-center justify-between gap-4 text-sm text-zinc-600 dark:text-zinc-400 sm:flex-row">
            <p>
              © {currentYear} DevPod. Built with Next.js and Sanity CMS.
            </p>
            <div className="flex gap-6">
              <button className="transition-colors hover:text-zinc-900 dark:hover:text-zinc-50">
                Privacy
              </button>
              <button className="transition-colors hover:text-zinc-900 dark:hover:text-zinc-50">
                Terms
